...
CUDA_VISIBLE_DEVICES=1 nohup python -m datapreparation.kitti360pose.prepare --scene_name 2013_05_28_drive_0005_sync --path_in /home/wanglichao/KITTI-360 --path_out ./data/k360_new --cell_size 30 --cell_dist 10 --pose_dist 10 --pose_count 4 --shift_poses --grid_cells >> log_k360_new_0005.txt &
...
CUDA_VISIBLE_DEVICES=2 nohup python -m datapreparation.kitti360pose.prepare --scene_name 2013_05_28_drive_0006_sync --path_in /home/wanglichao/KITTI-360 --path_out ./data/k360_new --cell_size 30 --cell_dist 10 --pose_dist 10 --pose_count 4 --shift_poses --grid_cells >> log_k360_new_0006.txt &

CUDA_VISIBLE_DEVICES=3 python -m datapreparation.kitti360pose.prepare --scene_name 2013_05_28_drive_0007_sync --path_in /home/wanglichao/KITTI-360 --path_out ./data/k360_new --cell_size 30 --cell_dist 10 --pose_dist 10 --pose_count 4 --shift_poses --grid_cells
