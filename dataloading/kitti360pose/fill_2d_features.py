...
object_base_path = "/home/wanglichao/KITTI-360/objects_text/"
...
for scene_name in cell_files:
    ...
    with open(cell_path, "rb") as f, open(objs_path, "rb") as f2:
        ...
        for cell in cells:
            for cell_obj in cell.objects:
                ...
                if match:
                    cell_obj.feature_2d = match.feature_2d
    ...
    save_path = f"/home/wanglichao/Text2Position/data/k360_30-10_scG_pd10_pc4_spY_all_clip_text/cells/{scene_name}"
    # 创建保存目录（如果不存在）
