...
if __name__ == "__main__":
    # Create a dummy TransformerCrossEncoderLayer
    ...
    print("Source Output Shape:", src_out.shape)
    print("Target Output Shape:", tgt_out.shape)
    print("Time Dictionary:", time_dict_global)
